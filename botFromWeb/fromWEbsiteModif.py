...
from grabTags import noTagsURL
from login2 import *
...
for hashtag in hashtag_list:
    ...
    driver.get('https://www.instagram.com/explore/tags/' + noTagsURL[tag] + '/')
    ...
    while True:
        i += 1
        Ntlike += 1
        kNext = driver.find_element_by_xpath('/html/body/div[4]/div[1]/div/div/a[2]')
        kNext.click()
        sleep(random.uniform(1, 10))
        # driver.find_elements_by_css_selector('.fr66n > button: nth - child(1)').click()
        driver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[1]/button').click()
        sleep(random.uniform(1, 10))

        if (i == 6):
            print('Jumlah postingan yang di like : ', i, sep="ke - ")
            break
#     try:
...
#                     tlike = driver.find_element_by_xpath(
...
#                         comments += 1
#                         driver.find_element_by_xpath(
#                             '/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[2]/button/svg').click()
...
#
#                 # Next picture
#                     driver.find_element_by_link_text('Berikutnya').click()
#                     sleep(randint(25, 29))
#             else:
#                 driver.find_element_by_link_text('Berikutnya').click()
#                 sleep(randint(20, 26))
...
print('Liked {} photos.'.format(Ntlike))
